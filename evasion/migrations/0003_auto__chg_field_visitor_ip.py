...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visitor.ip'
        db.alter_column(u'evasion_visitor', 'ip', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Visitor.ip'
        db.alter_column(u'evasion_visitor', 'ip', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))

    models = {
        u'evasion.message': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Message'},
            'date_filled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_message': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 0, 0)'}),
